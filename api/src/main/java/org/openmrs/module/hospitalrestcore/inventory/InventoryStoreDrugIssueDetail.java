...
public class InventoryStoreDrugIssueDetail extends CustomBaseOpenmrsObject implements Serializable,
        Comparable<InventoryStoreDrugIssueDetail> {
    ...
    @Override
    public int compareTo(InventoryStoreDrugIssueDetail o) {
